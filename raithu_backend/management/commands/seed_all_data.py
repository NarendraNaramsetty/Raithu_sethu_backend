...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"✓ Seeded {len(schemes)} Government Schemes & Subsidies"))
        ...
        self.stdout.write(self.style.SUCCESS(f"✓ Seeded {len(diseases)} Crop Disease Profiles"))
        ...
        self.stdout.write(self.style.SUCCESS(f"✓ Seeded {len(mandi_records)} Mandi APMC Commodity Prices"))
        ...
        post2 = ForumPost.objects.create(
            ...
            crop="Paddy & Maize",
            content="🚜 John Deere 5050 D (50 HP Tractor) with Rotavator and MB Plough available for rent. Hourly rate: ₹850/hr including diesel and operator. Call/WhatsApp: 9848012345.",
            likes=28,
            replies_count=1,
            is_rental=True,
        ...
        post3 = ForumPost.objects.create(
            ...
            content="🚁 DGCA-certified Agri Drone Spraying service available! Covers 1 acre in 7 minutes with uniform micron droplet coverage. Charges: ₹450 per acre. Saves 30% chemical and 90% water.",
            likes=42,
            replies_count=3,
            is_rental=True,
            time_ago="1 day ago"
        ...
        post4 = ForumPost.objects.create(
            ...
            content="PM-KISAN 19th installment e-KYC status update: Make sure your bank account is linked to NPCI Aadhaar bridge before the end of the month to receive the ₹2,000 credit smoothly.",
            likes=35,
            replies_count=1,
            is_rental=False,
            time_ago="1 day ago"
        ...
        self.stdout.write(self.style.SUCCESS("✓ Seeded Farmer Community Forum & Rental Posts with Replies"))
        ...
        forecasts = [
            DailyForecast(report=w_report, day_name="Mon", temp_range="24°C - 33°C", condition="Partly Cloudy", rain_chance="15%"),
            DailyForecast(report=w_report, day_name="Tue", temp_range="25°C - 34°C", condition="Sunny & Clear", rain_chance="10%"),
            DailyForecast(report=w_report, day_name="Wed", temp_range="24°C - 32°C", condition="Scattered Clouds", rain_chance="25%"),
            DailyForecast(report=w_report, day_name="Thu", temp_range="23°C - 31°C", condition="Light Showers", rain_chance="45%"),
            DailyForecast(report=w_report, day_name="Fri", temp_range="23°C - 30°C", condition="Thunderstorms", rain_chance="60%"),
            DailyForecast(report=w_report, day_name="Sat", temp_range="24°C - 32°C", condition="Passing Showers", rain_chance="35%"),
            DailyForecast(report=w_report, day_name="Sun", temp_range="25°C - 33°C", condition="Partly Cloudy", rain_chance="20%"),
        ]
        DailyForecast.objects.bulk_create(forecasts)
        self.stdout.write(self.style.SUCCESS("✓ Seeded Weather Agro-Advisory and 7-Day Forecasts"))

        self.stdout.write(self.style.SUCCESS("\n🎉 All Realistic 2026 Agricultural Datasets Seeded Successfully!"))
